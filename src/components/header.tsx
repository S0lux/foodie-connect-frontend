...
export default function Header({ children }: { children: React.ReactNode }) {
  return (
    <div className="fixed left-0 right-0 top-0 z-10 flex h-[--header-height] max-w-full items-center justify-between border-b border-primary/50 bg-inherit pl-4 pr-4">
